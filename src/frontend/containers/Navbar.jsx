    ...
    <nav className="contenedor__Navbar">
      <div className="links__Navbar">
        <div>
          ...
          <a
            href="https://www.facebook.com/VinculacionDETRI"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div>
          ...
          <a
            href="https://www.instagram.com/detri.fiee/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div>
      ...
      <div className="accesos__Navbar">
        {AccesosNavbar.map((item) => (
          <div
            ...
            key={item.id}
            onMouseEnter={() => handleAccessClick(item.id)} // Añadir manejador de clics
          >
            {item.Nombre}
